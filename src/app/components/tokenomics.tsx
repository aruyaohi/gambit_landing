  ...
  return (
    ...
    >
      <div className="lg:flex lg:flex-col lg:w-1/2 lg:gap-3 gap-10 font-raleway font-bold lg:px-20 px-10 py-10 lg:py-10">
        <h1 className="text-4xl pb-3">Have a favourite Game?</h1>
      </div>
      ...
      <div className="lg:w-1/2 lg:px-10 px-10 lg:flex lg:flex-col gap-3 font-bold font-raleway">
        ...
        >
          <span className="absolute -left-8 top-0 text-[#09FF22] text-5xl font-bold">“</span>
          ...
          <span className="absolute -right-4 bottom-0 text-[#09FF22] text-5xl font-bold"> ”</span>
        </motion.p>
      </div>
    </motion.div>
  );
